package com.pzoom.xiaolei.apachetools.dbutils;
...
public class ParamterUtils {
     ...
     * @return
     */
    public String createParamMark(Integer size) {
     ...
     */
    public void setParamters(List<?> paramters, PreparedStatement ps) throws SQLException {
